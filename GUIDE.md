...
|---------|------|------|
| 標題 | Title | 文章標題（必填） |
| 摘要 | Rich Text | 100 字以內摘要 |
| 來源 | Select | Instagram / Threads / Twitter / YouTube / Facebook / LinkedIn / 其他 |
| 標籤 | Select | AI 判斷的主題標籤 |
| 連結 | URL | 原始網址 |
| 作者 | Rich Text | 發文者帳號或姓名 |
| 內容 | Rich Text | 正文前 200 字 |
| 收藏日期 | Date | 儲存當天日期 |

> 欄位不一定要全部都有，Bot 會自動跳過不存在的欄位。
